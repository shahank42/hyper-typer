      ...
      <div className="text-left space-y-16 w-full max-w-4xl">
        <div className="space-y-2">
          ...
          <div className="flex items-baseline gap-4">
            ...
            <div className="text-2xl font-bold uppercase tracking-widest text-muted-foreground opacity-50">
              WPM
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 border-t border-border/50 pt-12">
          <div className="space-y-1">
            <div className="text-sm font-bold uppercase tracking-widest text-muted-foreground opacity-50">
              Accuracy
            </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 pt-8">
          ...
          <div className="flex items-center gap-3 text-muted-foreground/40 font-mono text-sm uppercase tracking-widest">
            <kbd className="rounded-md border border-border/50 bg-muted px-2 py-1 text-xs font-black text-muted-foreground/60">
              TAB
            </kbd>
            <span>+</span>
            <kbd className="rounded-md border border-border/50 bg-muted px-2 py-1 text-xs font-black text-muted-foreground/60">
